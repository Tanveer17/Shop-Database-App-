...
public class AccessDatabase {
    ...
    {
        try {
            instance.connection = DriverManager.getConnection("jdbc:mysql://localhost/shop_software", userName, password);
            return true;
    ...
    {
        Statement st = connection.createStatement();
        ResultSet rs = st.executeQuery("SELECT orders.id, quantity,order_date," +
                "CONCAT(customers.first_name,' ' ,customers.last_name) AS 'customer_name'," +
                "products.name, product_types.name, quantity*products.price AS 'price' " +
    ...
    public ObservableList<Sale> getSales()
    {
        ...
        {
            Statement st = connection.createStatement();
            ResultSet rs = st.executeQuery("SELECT sales.id,CONCAT(customers.first_name,' ',customers.last_name) AS 'customer_name',products.name,product_types.name,sales.sale_date,sales.quantity" +
            ...
            while (rs.next()) {
                ...
                Date date = rs.getDate("sales.sale_date");
