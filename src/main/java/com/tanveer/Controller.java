...
public class Controller {
    ...
    public void initialize() throws Exception {
        ...
        tables.getSelectionModel().selectedItemProperty().addListener((observableValue,  o, t1) -> {
                // hides the tables data first up
               hideTablesData();
    ...
    private void makeCustomerTable() throws Exception {
        ...
        //listener if a customer is added it can refelect in the table directly
        list.addListener((ListChangeListener<? super Customer>) (change )-> customer.getItems().add(list.get(list.size() - 1)));
